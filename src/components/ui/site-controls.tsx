...
export default function SiteControls() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-3 top-3 z-50 flex justify-center sm:inset-x-auto sm:right-5 sm:top-4 sm:justify-end">
      <div className="pointer-events-auto flex max-w-[calc(100vw-24px)] items-center gap-1.5 rounded-full border border-slate-200/70 bg-white/82 px-1.5 py-1.5 shadow-[0_18px_44px_rgba(15,23,42,0.1)] backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/72 dark:shadow-[0_20px_48px_rgba(2,6,23,0.34)]">
...
function IconButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={[
        'inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full transition-colors duration-150',
        active
